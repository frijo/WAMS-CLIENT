...
const appRoutes: Routes =[
	...
	{path: 'users',component: UserComponent,canActivate:[SessionGuard,SessionGuardAdmin]},
	{path: 'edit-user/:id',component: EditUserComponent,canActivate:[SessionGuard,SessionGuardAdmin]},
